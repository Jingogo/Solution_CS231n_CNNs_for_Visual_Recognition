...
def affine_relu_forward(x, w, b, normalization=None, gamma=None, beta=None,
                        bn_param=None, use_dropout=False, dropout_param=None):
    """
...
def affine_relu_backward(dout, cache, normalization=None, use_dropout=False):
    """
