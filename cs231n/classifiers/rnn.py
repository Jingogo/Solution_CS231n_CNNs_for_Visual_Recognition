...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        x, embedded_cache = word_embedding_forward(captions_in, W_embed)
        ...
        # Calculate gradient
        dh, dW_vocab, db_vocab = temporal_affine_backward(d_scores, affine_cache)
        if self.cell_type == 'rnn':
        ...
        dW_proj = np.matmul(features.transpose(), dh0)
